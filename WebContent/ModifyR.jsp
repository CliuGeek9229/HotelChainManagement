...
function mycheck(){
  ...
  <div class="block">
            <p class="block-heading">修改房间信息</p>
            <div class="block-body">
                <form action="<c:url value="room!UpdateRoom.action"/>" method="post" name="form1" onsubmit="return mycheck()">
                    <fieldset>
                    <div>
                    <label for="roomId">房间序号</label>
                    <input type="text" class="" id="roomId" name="room.roomId" value="${ roomform.roomId }" >
                    </div>
                    <div>
                    <label for="roomnum">房间号</label>
                    <input type="text" class="" name="room.roomnum" id="roomnum" value="${ roomform.roomnum }" >
                    </div>
              
                    <div>
                    <label for="type">房间类型</label>
                    <input type="text" class="" name="room.type" id="type" value="${ roomform.type }">
                    </div>
                    <div>
                    <label for="price">房间价位</label>
                    <input type="text" class="" name="room.price" id="price" value="${roomform.price }">
                    </div>
                    <div>
                    <label for="status">房间状态</label>
                    <input type="text" class="" name="room.status" id="status" value="${roomform.status }">
                    </div>
                    <div>
                    <label for="description">房间描述</label>
                    <textarea name="room.description" style="width:600px;height:60px;" id="description" >${ roomform.description }</textarea>
                    </div>
                    </fieldset>
