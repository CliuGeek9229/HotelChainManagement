...
function mycheck(){
	   if(isNull(form1.title.value)){  
	   alert("请输入公告标题！"); 
	   return false;
	   }
	   if(isNull(form1.days.value)){
	   alert("请输入公告有效时间！");
	   return false;
	   }
...
<div class="block">
            ...
            <div class="block-body">
                <form action="<c:url value="notice!InsertNotice.action"/>" method="post" name="form1" onsubmit="return mycheck()">
                    <fieldset>
                    <div>
                    <label for="title">公告标题</label>
                    <input type="text" class="" id="title" name="notice.title">
                    </div>
                    <div>
                    <label for="days">公告有效天数</label>
                    <input type="text" class="" id="days" name="notice.days">
                    </div>
                    <div>
                    <label for="status">公告状态</label>
                    <input id="status" name="notice.status" type="text" class="">
                    </div>
                    <div>
                    <label for="detail">公告内容</label>
                    <input type="text" class="" id="detail" name="notice.detail">
                    </div>
                    </fieldset>
                    
                    <div class="pull-right">
                    	<button type="submit" class="btn btn-warning btn-large" style="margin-right: 10px">添加</button>
